...
int main(int argc, char * argv[]) {
	...
	for (unsigned int iterator = 0; iterator < intervals_count; iterator++) {
		...
		interval_length = rand() % (elements_in_f2_count - interval_start);
